...
public class StudentController {
    ...
    public ResponseEntity<?> postStudent(@RequestBody @Valid StudentRequest studentRequest){
    ...
    public ResponseEntity<?> putStudent(@PathVariable Long id,@RequestBody @Valid StudentRequest studentRequest){
